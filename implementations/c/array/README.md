# array - c implementation slot

<!-- TODO: replace this placeholder with the learner-authored or learner-and-AI co-developed c implementation of `array`. -->

This folder is a placeholder slot created by `scripts/scaffold_topic.py`. It
exists so the canonical location for the c implementation of `array` is
ready when a study session reaches it.

Contract (see `docs/ARTIFACT_POLICY.md`):

- Code in this folder must be **runnable as study code** in c.
